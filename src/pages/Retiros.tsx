            ...
            {stakeStep === "input" && (
              <>
                ...
                <input
                  ...
                  className="w-full text-3xl font-bold text-foreground bg-secondary rounded-xl px-4 py-4 outline-none focus:ring-2 focus:ring-accent/20 transition-shadow tabular-nums mb-2"
                  min="1"
                  max={balance}
                />
